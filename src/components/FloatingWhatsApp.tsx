...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_-8px_rgba(37,211,102,0.6)] hover:scale-110 transition-transform"
    >
